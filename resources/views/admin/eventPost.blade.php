            ...
            <form action="{{ route('event.store') }}" method="post" role="form" class="contactForm" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-lg-10 col-md-10">
                            <input type="text" name="nama_event" id="judul_artikel" placeholder="" data-rule="minlen:4" class="form-control" data-msg="Please enter at least 8 chars of subject" />
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-lg-10 col-md-10">
                            <input type="date" name="tanggal_event" id="judul_artikel" placeholder="" data-rule="minlen:4" class="form-control" data-msg="Please enter at least 8 chars of subject" />
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-lg-10 col-md-10">
                            <input type="time" name="jam_event"  placeholder="" data-rule="minlen:4" class="form-control" data-msg="Please enter at least 8 chars of subject" />
                        </div>
                    </div>
                </div>
