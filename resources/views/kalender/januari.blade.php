...
<section id="content">
        <div class="container" style="margin-top:-30px;">
                <div class="row">
                  <div class="span12">
                    <a href="/februari" class="btn btn-success btn-large animated fadeInUp" style="float:right;"> > </a>
                  </div>
                </div>
              </div>
  <div class="container">
      <div class="span8" style="margin-left:auto; margin-right:auto;">
      <h4>{{$bulanJan->nama_bulan}} 2019</h4>
            ...
            <div class="portfolio-detail">
                <div class="row">
                    <div class="span12" style="background-color:azure; margin-top:-30px;">
                        @foreach ($bulanJan->tanggals()->get() as $bulan)
        ...
        <div class="row">
          <div class="span12">
            ...
            <ul class="portfolio-categ filter">
                @foreach ($bulanJan->kalenders()->get() as $peristiwa)
                <li class="all active"><a href="#" disable>{{ $peristiwa->tanggal_id }} {{$bulanJan->nama_bulan}} {{ $peristiwa->nama_peristiwa }}</a></li><br>
                @endforeach
              </ul>
          </div>
